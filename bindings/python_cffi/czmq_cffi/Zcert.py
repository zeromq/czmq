...
class Zcert(object):
    ...
    def set_meta(self, name, format, ):
        ...
        """
        return utils.lib.zcert_set_meta(self._p, utils.to_bytes(name), format, )

    def unset_meta(self, name):
        """
        Unset certificate metadata.
        """
        return utils.lib.zcert_unset_meta(self._p, utils.to_bytes(name))
    ...
    def apply(self, socket):
        ...
        """
        return utils.lib.zcert_apply(self._p, socket._p)
    ...
    def print_py(self):
        ...
        """
        return utils.lib.zcert_print(self._p)

    def test(verbose):
        """
        Self test of this class
        """
        return utils.lib.zcert_test(verbose)
