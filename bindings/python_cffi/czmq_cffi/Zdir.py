...
class Zdir(object):
    ...
    def remove(self, force):
        ...
        """
        return utils.lib.zdir_remove(self._p, force)
    ...
    def fprint(self, file, indent):
        ...
        """
        return utils.lib.zdir_fprint(self._p, file, indent)

    def print_py(self, indent):
        """
        Print contents of directory to stdout
        """
        return utils.lib.zdir_print(self._p, indent)
    ...
    def watch(pipe, unused):
        ...
        """
        return utils.lib.zdir_watch(pipe._p, unused._p)

    def test(verbose):
        """
        Self test of this class.
        """
        return utils.lib.zdir_test(verbose)
