...
class Zcertstore(object):
    ...
    def set_loader(self, loader, destructor, state):
        ...
        """
        return utils.lib.zcertstore_set_loader(self._p, loader, destructor, state)
    ...
    def insert(self, cert_p):
        ...
        """
        return utils.lib.zcertstore_insert(self._p, cert_p._p)
    ...
    def empty(self):
        ...
        """
        return utils.lib.zcertstore_empty(self._p)

    def print_py(self):
        """
        Print list of certificates in store to logging facility
        """
        return utils.lib.zcertstore_print(self._p)
    ...
    def test(verbose):
        ...
        """
        return utils.lib.zcertstore_test(verbose)
