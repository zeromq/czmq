...
class QT_CZMQ_EXPORT QZlistx : public QObject
{
    Q_OBJECT
public:

    //  Copy-construct to return the proper wrapped c types
    QZlistx (zlistx_t *self, QObject *qObjParent = 0);

    //  Create a new, empty list.
    explicit QZlistx (QObject *qObjParent = 0);
    ...
    static QZlistx* unpack (QZframe *frame, QObject *qObjParent = 0);
    ...
    static void * handleItem (void *handle);
    ...
    //  through a list.
    int deleteNoConflict (void *handle);
