...
Java_zconfig__1_1destroy (JNIEnv *env, jclass c, jlong self_p)
{
...
JNIEXPORT jstring JNICALL
Java_zconfig__1_1value (JNIEnv *env, jclass c, jlong self)
{
...
JNIEXPORT void JNICALL
Java_zconfig__1_1putf (JNIEnv *env, jclass c, jlong self, jstring path, jstring format)
{
    char *path_ = (char *) (*env)->GetStringUTFChars (env, path, NULL);
...
JNIEXPORT jstring JNICALL
Java_zconfig__1_1get (JNIEnv *env, jclass c, jlong self, jstring path, jstring default_value)
{
    char *path_ = (char *) (*env)->GetStringUTFChars (env, path, NULL);
...
JNIEXPORT jlong JNICALL
Java_zconfig__1_1child (JNIEnv *env, jclass c, jlong self)
{
...
JNIEXPORT jlong JNICALL
Java_zconfig__1_1next (JNIEnv *env, jclass c, jlong self)
{
...
JNIEXPORT jlong JNICALL
Java_zconfig__1_1locate (JNIEnv *env, jclass c, jlong self, jstring path)
{
    char *path_ = (char *) (*env)->GetStringUTFChars (env, path, NULL);
...
JNIEXPORT jlong JNICALL
Java_zconfig__1_1at_depth (JNIEnv *env, jclass c, jlong self, jint level)
{
...
JNIEXPORT void JNICALL
Java_zconfig__1_1set_comment (JNIEnv *env, jclass c, jlong self, jstring format)
{
    char *format_ = (char *) (*env)->GetStringUTFChars (env, format, NULL);
...
JNIEXPORT jlong JNICALL
Java_zconfig__1_1comments (JNIEnv *env, jclass c, jlong self)
{
...
JNIEXPORT jint JNICALL
Java_zconfig__1_1save (JNIEnv *env, jclass c, jlong self, jstring filename)
{
    char *filename_ = (char *) (*env)->GetStringUTFChars (env, filename, NULL);
...
JNIEXPORT jint JNICALL
Java_zconfig__1_1savef (JNIEnv *env, jclass c, jlong self, jstring format)
{
    char *format_ = (char *) (*env)->GetStringUTFChars (env, format, NULL);
...
JNIEXPORT jstring JNICALL
Java_zconfig__1_1filename (JNIEnv *env, jclass c, jlong self)
{
...
JNIEXPORT jint JNICALL
Java_zconfig__1_1reload (JNIEnv *env, jclass c, jlong self_p)
{
...
JNIEXPORT jlong JNICALL
Java_zconfig__1_1chunk_load (JNIEnv *env, jclass c, jlong chunk)
{
...
JNIEXPORT jlong JNICALL
Java_zconfig__1_1chunk_save (JNIEnv *env, jclass c, jlong self)
{
...
JNIEXPORT jlong JNICALL
Java_zconfig__1_1str_load (JNIEnv *env, jclass c, jstring string)
{
...
JNIEXPORT jstring JNICALL
Java_zconfig__1_1str_save (JNIEnv *env, jclass c, jlong self)
{
...
Java_zconfig__1_1has_changed (JNIEnv *env, jclass c, jlong self)
{
...
JNIEXPORT void JNICALL
Java_zconfig__1_1print (JNIEnv *env, jclass c, jlong self)
{
    zconfig_print ((zconfig_t *) self);
}

JNIEXPORT void JNICALL
Java_zconfig__1_1test (JNIEnv *env, jclass c, jboolean verbose)
{
