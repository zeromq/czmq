...
This project is tested against Android NDK version r22b.

If you installed version r22b all you have to do is to expose the NDK root
directory as environment variable, e.g:

    export ANDROID_NDK_ROOT=$HOME/android-ndk-r22b
