...
function android_build_env {
    ...
    if [ -z "$ANDROID_NDK_ROOT" ]; then
        ...
        ANDROID_BUILD_FAIL+=("  (eg. \"/home/user/android/android-ndk-r22b\")")
    fi

    if [ -z "$TOOLCHAIN_PATH" ]; then
        ANDROID_BUILD_FAIL+=("Please set the TOOLCHAIN_PATH environment variable")
        ANDROID_BUILD_FAIL+=("  (eg. \"/home/user/android/android-ndk-r22b/toolchains/arm-linux-androideabi-4.9/prebuilt/linux-x86_64/bin\")")
    fi
