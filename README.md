...
&emsp;<a href="#toc4-176">zfile - work with files</a>
&emsp;<a href="#toc4-187">zframe - working with single message frames</a>
&emsp;<a href="#toc4-198">zmsg - working with multipart messages</a>
&emsp;<a href="#toc4-209">zloop - event-driven reactor</a>
&emsp;<a href="#toc4-220">zthread - working with system threads</a>
&emsp;<a href="#toc4-231">zhash - expandable hash table container</a>
&emsp;<a href="#toc4-242">zlist - singly-linked list container</a>
&emsp;<a href="#toc4-253">zclock - millisecond clocks and delays</a>

**<a href="#toc2-264">Design Ideology</a>**
&emsp;<a href="#toc3-267">The Problem with C</a>
&emsp;<a href="#toc3-276">A Simple Class Model</a>
&emsp;<a href="#toc3-303">Naming Style</a>
&emsp;<a href="#toc3-312">Containers</a>
&emsp;<a href="#toc3-324">Portability</a>
&emsp;<a href="#toc3-350">Technical Aspects</a>

**<a href="#toc2-360">Under the Hood</a>**
&emsp;<a href="#toc3-363">Adding a New Class</a>
&emsp;<a href="#toc3-376">Coding Style</a>
&emsp;<a href="#toc3-395">Assertions</a>
&emsp;<a href="#toc3-413">Documentation</a>
&emsp;<a href="#toc3-452">Development</a>
&emsp;<a href="#toc3-462">Porting czmq</a>
&emsp;<a href="#toc3-475">Code Generation</a>
&emsp;<a href="#toc3-484">This Document</a>
...
<A name="toc4-176" title="zfile - work with files" />
...
<A name="toc4-187" title="zframe - working with single message frames" />
...
<A name="toc4-198" title="zmsg - working with multipart messages" />
...
<A name="toc4-209" title="zloop - event-driven reactor" />
...
<A name="toc4-220" title="zthread - working with system threads" />
...
<A name="toc4-231" title="zhash - expandable hash table container" />
...
<A name="toc4-242" title="zlist - singly-linked list container" />
...
<A name="toc4-253" title="zclock - millisecond clocks and delays" />
...
<A name="toc2-264" title="Design Ideology" />
## Design Ideology

<A name="toc3-267" title="The Problem with C" />
### The Problem with C
...
<A name="toc3-276" title="A Simple Class Model" />
...
<A name="toc3-303" title="Naming Style" />
### Naming Style
...
<A name="toc3-312" title="Containers" />
### Containers
...
<A name="toc3-324" title="Portability" />
### Portability
...
<A name="toc3-350" title="Technical Aspects" />
### Technical Aspects
...
<A name="toc2-360" title="Under the Hood" />
## Under the Hood

<A name="toc3-363" title="Adding a New Class" />
### Adding a New Class
...
<A name="toc3-376" title="Coding Style" />
### Coding Style
...
<A name="toc3-395" title="Assertions" />
### Assertions
...
<A name="toc3-413" title="Documentation" />
### Documentation
...
<A name="toc3-452" title="Development" />
### Development
...
<A name="toc3-462" title="Porting czmq" />
### Porting czmq
...
<A name="toc3-484" title="This Document" />
### This Document
